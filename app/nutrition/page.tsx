...
import { getProfile, getNutrition, saveNutrition, getFavouriteFoods, saveFavouriteFood, deleteFavouriteFood, getGlucoseSettings } from '@/lib/firebase/firestore'
...
import { FOOD_DATABASE, FoodEntry, LOWER_GI_SWAPS } from '@/lib/food/foodDatabase'
