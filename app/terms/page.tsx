      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="glass rounded-2xl p-6 space-y-6 text-sm text-2 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              By creating an account or using HealthOS, you agree to be bound by these
              Terms of Service and our Privacy Policy. If you do not agree, do not use the service.
            </p>
            <p>
              You must be at least 18 years old to use  HealthOS. By registering, you confirm that you are 18
          ...
          <section className="space-y-2">
            ...
            <p>
              HealthOS is a personal health and fitness tracking application that provides tools for
            ...
            <p className="font-semibold text-1">
              HealthOS is not a medical device, clinical tool, or substitute for professional medical advice,
          ...
          <section className="space-y-2">
            ...
            <p>
              HealthOS processes health-related data including body metrics, glucose readings, sleep patterns,
            ...
            <p>
              ...
              informed consent for HealthOS to process this data as described in our Privacy Policy. You may
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              <li>Use HealthOS for any unlawful purpose</li>
          ...
          <section className="space-y-2">
            ...
            <p>
              HealthOS uses AI models (including Claude by Anthropic) to generate nutritional analysis,
          ...
          <section className="space-y-2">
            ...
            <p>
              HealthOS offers Free, Pro, and Premium subscription tiers. Paid subscriptions are billed
          ...
          <section className="space-y-2">
            ...
            <p>
              To the fullest extent permitted by law, HealthOS and its operators shall not be liable for any
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              changes via email or in-app notification. Continued use of HealthOS after changes constitutes
        ...
        <p className="text-center text-xs text-3">
          By using HealthOS you confirm you have read and agree to these Terms of Service.
        </p>
      </div>
    </main>
  )
